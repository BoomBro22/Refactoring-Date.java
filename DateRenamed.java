...
public class Date
{
    ...
    public void setDate(String monthName, int day, int year)
    {
        if (dateOK(monthName, day, year)) // changed var monthString to monthName
        {
    ...
    // Re-written using new Switch statement expression
    public int getMonth() {
      ...
      return 0; // Need to keep the compiler happy
    }
    ...
    {
        return ( monthConfirmed(monthString) &&
                 (dayInt >= 1) && (dayInt <= 31) &&
                 (yearInt >= 1000) && (yearInt <= 9999) );
    }

    // Re-written monthOK using Switch statement expression
    private boolean monthConfirmed(String month) { // renamed monthOK to monthConfirmed
    ...
    private String monthName(int monthNumber) // rename monthString to monthName
    {
        switch (monthNumber) {
      ...
      System.exit(0);
      return "Error"; // keeps the compiler happy
    }
  }
